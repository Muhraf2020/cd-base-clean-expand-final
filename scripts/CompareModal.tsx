...
export default function CompareModal({ clinics, onClose }: CompareModalProps) {
  ...
  // Helper to get value with fallback (kept in case we want to reuse)
  const getValue = (
    clinic: Clinic,
      ...
      const response = await fetch('/api/send-comparison', {
        ...
        body: JSON.stringify({
          ...
          clinics: clinics.map((c) => ({
            ...
            // You may also want to include convenience_scores / languages_spoken
            // if you're storing them in Supabase and want them emailed:
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-7xl max-h-[90vh] flex flex-col">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">
              Comparing {clinics.length} dermatology clinics
              side-by-side
            </p>
          </div>
          <button
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="border-b-2 border-gray-300">
                  ...
                  {clinics.map((clinic) => (
                    <th
                      key={clinic.place_id}
                      className="p-4 bg-blue-50 min-w-[250px]"
                    >
                      <Link
              ...
              <tbody>
                ...
                <tr className="border-b border-gray-200">
                  <td
                    className="p-4 bg-gray-50 font-semibold sticky left-0 z-10"
                    ...
                    <tr className="border-b border-gray-100">
                      ...
                      {clinics.map((clinic) => (
                        ...
                        >
                          <span className="font-medium text-gray-900">
                            {clinic.intelligence_scores
                              ?.convenience_accessibility_score ||
                              'N/A'}
                          </span>
                        </td>
                      ))}
                            ...
                            <ul className="space-y-1 text-sm">
                              ...
                              {clinic.website_services.length > 5 && (
                                <li className="text-gray-500 italic">
                                  +
                                  {clinic.website_services.length -
                                    5}{' '}
                                  more
                                </li>
                              )}
                ...
                {/* 🔥 ADDITIONAL METRICS: Convenience Scores */}
                {clinics.some((c) => (c as any).convenience_scores) && (
                  <>
                    <tr className="border-b border-gray-200">
                      <td
                        className="p-4 bg-gray-50 font-semibold sticky left-0 z-10"
                    ...
                    <tr className="border-b border-gray-100">
                      ...
                      {clinics.map((clinic) => (
                        ...
                        >
                          <span className="font-medium text-gray-900">
                            {(clinic as any).convenience_scores
                              ?.parking_score || 'N/A'}
                          </span>
                        </td>
                      ))}
                ...
                {clinics.some(
                  (c) =>
                    (c as any).languages_spoken &&
                    (c as any).languages_spoken.length > 0
                ) && (
                  <>
                    <tr className="border-b border-gray-200">
                      <td
                    ...
                    <tr className="border-b border-gray-100">
                      ...
                      {clinics.map((clinic) => (
                        ...
                        >
                          ...
                          (clinic as any).languages_spoken.length >
                            0 ? (
                            <ul className="space-y-1 text-sm">
                              {(clinic as any).languages_spoken.map(
        ...
        <div className="border-t border-gray-200 p-6 bg-gray-50">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-green-800">
                    We've sent the comparison report to your email.
            ...
            <div className="mb-4">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="font-semibold text-gray-900 text-lg">
                  Send This Comparison to Your Email
                </h3>
              </div>
              ...
              >
                ...
                <div className="flex items-center justify-between pt-2">
                  <p className="text-sm text-gray-600">
                    We'll send you a detailed PDF comparison
                    report
                  </p>
          ...
          <p className="text-xs text-gray-500 text-center mt-4">
            All information is sourced from public records and
            clinic websites
          </p>
        </div>
      </div>
